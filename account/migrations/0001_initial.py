...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('desc', models.TextField(blank=True, null=True, verbose_name='团队描述')),
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='extra', to='auth.Group', verbose_name='团队/组')),
            ],
            options={
                'verbose_name': '团队信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='rooms', to='auth.Group', verbose_name='团队/组')),
            ],
            options={
                'verbose_name': '科室',
